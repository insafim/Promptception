...
if SETTING == 's10':
    ...
    PROMPTS_FILE = "Prompts/Prompts_MMMU-Pro-Vision.yaml"

OUTPUT_DIRECTORY = "Results/MMMU-Pro/MMMU-Pro_Intern-VL-8B_v"
OUTPUT_FILE = f"mmmu-pro_intern-vl-8B_{SETTING}_{PROMPT_NAME}.json"
...
# CUDA_VISIBLE_DEVICES=0 python Infer/mmmu-pro/infer_mmmu-pro_internvl2.5-8B.py s4 8.1 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_internvl2.5-8B_s4_8.1.txt
# CUDA_VISIBLE_DEVICES=1 python Infer/mmmu-pro/infer_mmmu-pro_internvl2.5-8B.py s4 8.2 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_internvl2.5-8B_s4_8.2.txt
# CUDA_VISIBLE_DEVICES=2 python Infer/mmmu-pro/infer_mmmu-pro_internvl2.5-8B.py s4 12.5 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_internvl2.5-8B_s4_12.5.txt
# CUDA_VISIBLE_DEVICES=3 python Infer/mmmu-pro/infer_mmmu-pro_internvl2.5-8B.py s4 8.4 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_internvl2.5-8B_s4_8.4.txt
# CUDA_VISIBLE_DEVICES=4 python Infer/mmmu-pro/infer_mmmu-pro_internvl2.5-8B.py s4 9.1 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_internvl2.5-8B_s4_9.1.txt
# CUDA_VISIBLE_DEVICES=5 python Infer/mmmu-pro/infer_mmmu-pro_internvl2.5-8B.py s4 9.2 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_internvl2.5-8B_s4_9.2.txt
# CUDA_VISIBLE_DEVICES=6 python Infer/mmmu-pro/infer_mmmu-pro_internvl2.5-8B.py s4 9.3 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_internvl2.5-8B_s4_9.3.txt
# CUDA_VISIBLE_DEVICES=7 python Infer/mmmu-pro/infer_mmmu-pro_internvl2.5-8B.py s4 10.1 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_internvl2.5-8B_s4_10.1.txt