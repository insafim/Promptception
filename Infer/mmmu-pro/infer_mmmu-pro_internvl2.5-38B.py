...
OUTPUT_DIRECTORY = "Results/MMMU-Pro/MMMU-Pro_Intern-VL-38B"
OUTPUT_FILE = f"mmmu-pro_intern-vl-38B_{SETTING}_{PROMPT_NAME}.json"
...
# CUDA_VISIBLE_DEVICES=4 python Infer/mmmu-pro/infer_mmmu-pro_internvl2.5-8B.py s4 1.3 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_internvl2.5-8B_s4_1.3.txt