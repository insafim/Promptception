...
OUTPUT_DIRECTORY = "Results/MMMU-Pro/MMMU-Pro_Qwen2-VL-2B"
OUTPUT_FILE = f"mmmu-pro_qwen2-vl-2B_{SETTING}_{PROMPT_NAME}.json"
...
# CUDA_VISIBLE_DEVICES=1 python Infer/infer_mmmu-pro_qwen2-vl.py 12.1 | tee -a Outputs/mmmu-pro_qwen2-vl_1.2.txt
