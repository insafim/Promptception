...
OUTPUT_DIRECTORY = "Results/MMMU-Pro/MMMU-Pro_Qwen2-VL-7B"
OUTPUT_FILE = f"mmmu-pro_qwen2-vl-7B_{SETTING}_{PROMPT_NAME}.json"
...
# CUDA_VISIBLE_DEVICES=0 python Infer/mmmu-pro/infer_mmmu-pro_qwen2-vl-7B.py s4 7.1 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_qwen2-vl-7B_s4_1.1.txt
# CUDA_VISIBLE_DEVICES=1 python Infer/mmmu-pro/infer_mmmu-pro_qwen2-vl-7B.py s4 12.5 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_qwen2-vl-7B_s4_12.5.txt
# CUDA_VISIBLE_DEVICES=2 python Infer/mmmu-pro/infer_mmmu-pro_qwen2-vl-7B.py s4 7.3 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_qwen2-vl-7B_s4_1.3.txt
# CUDA_VISIBLE_DEVICES=3 python Infer/mmmu-pro/infer_mmmu-pro_qwen2-vl-7B.py s4 7.4 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_qwen2-vl-7B_s4_2.1.txt
# CUDA_VISIBLE_DEVICES=4 python Infer/mmmu-pro/infer_mmmu-pro_qwen2-vl-7B.py s4 7.5 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_qwen2-vl-7B_s4_2.2.txt
# CUDA_VISIBLE_DEVICES=5 python Infer/mmmu-pro/infer_mmmu-pro_qwen2-vl-7B.py s4 7.6 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_qwen2-vl-7B_s4_2.3.txt
# CUDA_VISIBLE_DEVICES=6 python Infer/mmmu-pro/infer_mmmu-pro_qwen2-vl-7B.py s4 8.1 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_qwen2-vl-7B_s4_15.1.txt
# CUDA_VISIBLE_DEVICES=7 python Infer/mmmu-pro/infer_mmmu-pro_qwen2-vl-7B.py s4 8.2 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_qwen2-vl-7B_s4_14.2.txt
