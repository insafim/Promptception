...
OUTPUT_DIRECTORY = "Results/MMMU-Pro/MMMU-Pro_Llava-OV-7B"
OUTPUT_FILE = f"mmmu-pro_llava-ov-7B_{SETTING}_{PROMPT_NAME}.json"
...
def run_and_save():
    ...
    for idx, data in enumerate(tqdm(dataset, desc="Processing dataset")):
        ...
        print(f"Coversation for id {entry_id}: {conversation}")
...
# CUDA_VISIBLE_DEVICES=0 python Infer/mmmu-pro/infer_mmmu-pro_llava-ov-7B.py s4 12.5 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_llava-ov-7B_s4_12.5.txt
# CUDA_VISIBLE_DEVICES=1 python Infer/mmmu-pro/infer_mmmu-pro_llava-ov-7B.py s4 6.6 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_llava-ov-7B_s4_6.6.txt
# CUDA_VISIBLE_DEVICES=2 python Infer/mmmu-pro/infer_mmmu-pro_llava-ov-7B.py s4 14.2 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_llava-ov-7B_s4_14.2.txt
# CUDA_VISIBLE_DEVICES=3 python Infer/mmmu-pro/infer_mmmu-pro_llava-ov-7B.py s4 14.3 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_llava-ov-7B_s4_14.3.txt
# CUDA_VISIBLE_DEVICES=4 python Infer/mmmu-pro/infer_mmmu-pro_llava-ov-7B.py s4 15.1 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_llava-ov-7B_s4_15.1.txt
# CUDA_VISIBLE_DEVICES=5 python Infer/mmmu-pro/infer_mmmu-pro_llava-ov-7B.py s4 15.2 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_llava-ov-7B_s4_15.2.txt
# CUDA_VISIBLE_DEVICES=6 python Infer/mmmu-pro/infer_mmmu-pro_llava-ov-7B.py s4 15.3 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_llava-ov-7B_s4_15.3.txt
# CUDA_VISIBLE_DEVICES=7 python Infer/mmmu-pro/infer_mmmu-pro_llava-ov-7B.py s4 13.3 | tee -a Outputs/mmmu-pro/s4/mmmu-pro_llava-ov-7B_s4_13.3.txt