...
OUTPUT_DIRECTORY = "Results/MMStar/MMStar_Intern-VL-8B"
OUTPUT_FILE = f"mmstar_intern-vl-8B_{PROMPT_NAME}-wo_persona.json"
...
# CUDA_VISIBLE_DEVICES=2 python Infer/mmstar/infer_mmstar_internvl2.5-8B.py 12.5 | tee -a Outputs/mmstar/mmstar_internvl2.5-8B_12.5.txt