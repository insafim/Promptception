...
OUTPUT_DIRECTORY = "Results/MMStar/MMStar_Intern-VL-1B"
OUTPUT_FILE = f"mmstar_intern-vl-1B_{PROMPT_NAME}.json"
...
# CUDA_VISIBLE_DEVICES=0 python Infer/mmstar/infer_mmstar_internvl2.5-1B.py 12.1 | tee -a Outputs/mmstar/mmstar_internvl2.5-8B_12.1.txt
# CUDA_VISIBLE_DEVICES=1 python Infer/mmstar/infer_mmstar_internvl2.5-1B.py 12.2 | tee -a Outputs/mmstar/mmstar_internvl2.5-8B_12.2.txt
# CUDA_VISIBLE_DEVICES=2 python Infer/mmstar/infer_mmstar_internvl2.5-1B.py 12.3 | tee -a Outputs/mmstar/mmstar_internvl2.5-8B_12.3.txt
# CUDA_VISIBLE_DEVICES=3 python Infer/mmstar/infer_mmstar_internvl2.5-1B.py 12.5 | tee -a Outputs/mmstar/mmstar_internvl2.5-8B_12.5.txt
# CUDA_VISIBLE_DEVICES=4 python Infer/mmstar/infer_mmstar_internvl2.5-1B.py 13.4 | tee -a Outputs/mmstar/mmstar_internvl2.5-8B_13.4.txt
# CUDA_VISIBLE_DEVICES=5 python Infer/mmstar/infer_mmstar_internvl2.5-1B.py 14.1 | tee -a Outputs/mmstar/mmstar_internvl2.5-8B_14.1.txt
# CUDA_VISIBLE_DEVICES=6 python Infer/mmstar/infer_mmstar_internvl2.5-1B.py 14.2 | tee -a Outputs/mmstar/mmstar_internvl2.5-8B_14.2.txt
# CUDA_VISIBLE_DEVICES=7 python Infer/mmstar/infer_mmstar_internvl2.5-1B.py 14.3 | tee -a Outputs/mmstar/mmstar_internvl2.5-8B_14.3.txt
