...
OUTPUT_DIRECTORY = "Results/MMStar/MMStar_Llama"
OUTPUT_FILE = f"mmstar_llama_{PROMPT_NAME}_rerun.json"
...
# CUDA_VISIBLE_DEVICES=1 python Infer/mmstar/infer_mmstar_llama.py 1.1 | tee -a Outputs/mmstar/mmstar_llama_1.1_rerun.txt
# CUDA_VISIBLE_DEVICES=1 python Infer/mmstar/infer_mmstar_llama.py 4.3 | tee -a Outputs/mmstar/mmstar_llama_4.3.txt
# CUDA_VISIBLE_DEVICES=2 python Infer/mmstar/infer_mmstar_llama.py 4.1 | tee -a Outputs/mmstar/mmstar_llama_4.1.txt
# CUDA_VISIBLE_DEVICES=3 python Infer/mmstar/infer_mmstar_llama.py 4.2 | tee -a Outputs/mmstar/mmstar_llama_4.2.txt
