...
PROMPTS_FILE = "Prompts/Prompts_Video-Gemini_Claude.yaml"
LOCAL_DATA_PATH = "Datasets/MVBench/mvbench_100.json"
VIDEO_FOLDER = "Datasets/MVBench/mvbench_videos"

# Ouput directory and file 
OUTPUT_DIRECTORY = "Results/MVBench/MVBench_Gemini1.5-Pro"
OUTPUT_FILE = f"mvbench_gemini1.5-pro_{PROMPT_NAME}.json"
...
# python Infer/mvbench/infer_mvbench_gemini.py 1.1 | tee -a Outputs/mvbench/mvbench_gemini_1.1.txt
