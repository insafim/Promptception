...
OUTPUT_DIRECTORY = "Results/MVBench/MVBench_Intern-VL-38B"
OUTPUT_FILE = f"mvbench_intern-vl-38B_{PROMPT_NAME}.json"
...
# CUDA_VISIBLE_DEVICES=7 python Infer/mvbench/infer_mvbench_internvl2.5-8B.py 1.1 | tee -a Outputs/mmstar/mmstar_internvl2.5-8B_2.2.txt